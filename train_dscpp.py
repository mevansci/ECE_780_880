"""Train with DSC++ loss only.

Wrapper that configures `Trainer` for DSC++ training.
"""
import argparse
...
def parse_args():
    p = argparse.ArgumentParser(prog="train_dscpp.py")
    p.add_argument("--data-dir", default="data")
    p.add_argument("--out-dir", default="checkpoints-dscpp")
